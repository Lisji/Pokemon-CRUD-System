			...
			while ($rows = mysqli_fetch_all($result, MYSQLI_ASSOC)) {
				...
				for($i = 0; $i < $count; $i++){
					echo "<tr>";
						...
						echo "<form action='battle_go_update1.php' method='post'>";
						echo "<input type ='hidden' name='battle_update' value ='$ans'>";
						echo "<input type ='hidden' name='battle_update1' value ='$ans1'>";
						echo "<td><input type='submit' name='get_battle_update' value='修改'/></td>";
						echo "</form>";
					echo "</tr>";
